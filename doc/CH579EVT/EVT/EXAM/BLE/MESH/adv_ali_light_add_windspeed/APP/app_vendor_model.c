...
* Description    : 收到天猫精灵发出的设置属性值命令（无应答）
* Input          : None
* Return         : None
*******************************************************************************/
...
* Description    : 收到天猫精灵发出的confirm - 该消息用于Vendor Model Client回复给Vendor Model Server，
...
* Description    : 该消息用于Mesh设备与天猫精灵之间透传数据
* Input          : None
* Return         : None
*******************************************************************************/
...
* Description    : 移除列表，调用发送完成回调，释放缓存
* Input          : ind：需要重置的通知
										err： 错误码
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : bt_mesh_ind_alloc找一个空的
* Description    : 找一个空的indicate，并分配内存
* Input          : buf: 需要分配的数据内容
...
* Description    : 发送当前LED状态，当有LED状态更新时都需要调用此函数
* Input          : param： 发送通知的发送参数
* Return         : None
*******************************************************************************/
...
* Description    : 发送当前windspeed，当有windspeed更新时都需要调用此函数
* Input          : param： 发送通知的发送参数
* Return         : None
*******************************************************************************/
